    ...
    translation: {
      settings: {
        ...
        account: {
          ...
          bio: 'Bio',
          note: '※ アカウント情報の保存はまだ未対応です（今後実装します）。',
        },
      ...
      errors: {
        ...
        cannot_follow_virtual: 'フォロー中の年表はフォローできません',
    ...
    translation: {
      settings: {
        ...
        account: {
          ...
          bio: 'Bio',
          note: 'Note: saving account info is not implemented yet (coming soon).',
        },
        close: 'Close',
        ...
        barHeight: 'Period bar thickness',
        labelFont: 'Title font size',
      ...
      errors: {
        ...
        cannot_follow_virtual: 'You cannot follow a followed timeline',
