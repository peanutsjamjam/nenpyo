    ...
    translation: {
      settings: {
        ...
        account: {
          ...
          deleteConfirm: 'アカウントを削除すると、作成した年表・イベント・そのほかの情報は全て削除されますが、よろしいですか？',
        },
      ...
      auth: {
        ...
        submitLogin: 'ログイン',
        submitRegister: '確認メールを送る',
        sentTitle: '確認メールを送信しました',
        sentBody: '{{email}} 宛にリンク付きのメールを送りました。メール内のリンクを開いて登録を続けてください（リンクの有効期限は1時間です）。',
        resend: '別のメールアドレスで送り直す',
        forgot: 'パスワードをお忘れですか？',
        forgotTitle: 'パスワードの再設定',
        forgotSubmit: '再設定用リンクを送る',
        forgotSentTitle: 'メールを送信しました',
        forgotSentBody: 'そのメールアドレスが登録されていれば、パスワード再設定用のリンクを送りました。メールをご確認ください（リンクの有効期限は1時間です）。',
        backToLogin: 'ログインに戻る',
      },
      reset: {
        title: 'パスワードの再設定',
        emailLabel: '対象のメールアドレス',
        new: '新しいパスワード',
        confirm: '新しいパスワード（確認）',
        submit: 'パスワードを再設定する',
        verifying: 'リンクを確認しています…',
        restart: 'ログイン画面へ',
        mismatch: 'パスワードが一致しません',
      },
      signup2: {
        title: 'アカウント登録',
        emailLabel: '登録するメールアドレス',
        submit: '登録する',
        verifying: 'リンクを確認しています…',
        restart: '最初からやり直す',
      },
      ...
      errors: {
        ...
        mail_failed: 'メールの送信に失敗しました。時間をおいて再度お試しください。',
        signup_token_invalid: 'リンクが無効か、有効期限が切れています。最初からやり直してください。',
        reset_token_invalid: 'リンクが無効か、有効期限が切れています。もう一度お試しください。',
    ...
    translation: {
      settings: {
        ...
        account: {
          ...
          deleteConfirm: 'Deleting your account will permanently remove all your timelines, events, and other data. Are you sure?',
        },
      ...
      auth: {
        ...
        submitLogin: 'Log in',
        submitRegister: 'Send confirmation email',
        sentTitle: 'Confirmation email sent',
        sentBody: 'We sent a link to {{email}}. Open the link in that email to continue signing up (the link is valid for 1 hour).',
        resend: 'Use a different email',
        forgot: 'Forgot your password?',
        forgotTitle: 'Reset password',
        forgotSubmit: 'Send reset link',
        forgotSentTitle: 'Email sent',
        forgotSentBody: 'If that email is registered, we sent a password reset link. Please check your inbox (the link is valid for 1 hour).',
      ...
      errors: {
        ...
        mail_failed: 'Failed to send the email. Please try again later.',
        signup_token_invalid: 'This link is invalid or has expired. Please start over.',
        reset_token_invalid: 'This link is invalid or has expired. Please try again.',
